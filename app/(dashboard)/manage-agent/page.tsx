  ...
  if (!myAgent) {
    return (
      ...
      >
        ...
        >
          Create your trading agent in the Agent Factory to start monitoring performance, viewing live positions, and managing your strategy.
        </p>
        <button
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
        <div>
          ...
          <p style={{ margin: "4px 0 0", fontSize: 13, color: "rgba(255,255,255,0.30)" }}>
            Monitor performance, configure settings, and manage your trading agent.
          </p>
        </div>
